...
- Cron:
  ...
  - `CRON_SECRET` – optional shared secret used by the internal HTTP announcement‑expiry endpoint so external schedulers (e.g. GitHub Actions) can safely trigger it.
